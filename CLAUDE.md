...
**Other notable services**: `push_service.dart` (APNs token registration + per-pane notify config), `pane_log_service.dart` (`/pane-log/ws` consumer), `terminal_session.dart` (`/terminal/ws` PTY bridge).
