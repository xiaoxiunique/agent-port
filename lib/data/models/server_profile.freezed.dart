...
mixin _$ServerProfile {
 ...
 String get id; String get name; String get url; String? get token;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ServerProfile&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.url, url) || other.url == url)&&(identical(other.token, token) || other.token == token));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,url,token);
...
@useResult
$Res call({
 String id, String name, String url, String? token
});
...
/// Create a copy of ServerProfile
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? url = null,Object? token = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String url,  String? token)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ServerProfile() when $default != null:
return $default(_that.id,_that.name,_that.url,_that.token);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String url,  String? token)  $default,) {final _that = this;
switch (_that) {
case _ServerProfile():
return $default(_that.id,_that.name,_that.url,_that.token);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String url,  String? token)?  $default,) {final _that = this;
switch (_that) {
case _ServerProfile() when $default != null:
return $default(_that.id,_that.name,_that.url,_that.token);case _:
  return null;
...
class _ServerProfile implements ServerProfile {
  const _ServerProfile({required this.id, required this.name, required this.url, this.token});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ServerProfile&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.url, url) || other.url == url)&&(identical(other.token, token) || other.token == token));
}
...
/// Create a copy of ServerProfile
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? url = null,Object? token = freezed,}) {
